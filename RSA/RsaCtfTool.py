...
class RSAAttack(object):
    ...
    def fermat(self, fermat_timeout=60):
        ...
        try:
            ...
            if self.args.verbose:
                print("[!] Warning: Fermat factorization module missing (math2.py)")
            return
    ...
    def Pollard_p_1(self):
        ...
        pollard = PollardP1Attack(self.pub_key.n)
        if pollard.p is not None and pollard.q is not None :
            self.pub_key.p = pollard.p
            self.pub_key.q = pollard.q
